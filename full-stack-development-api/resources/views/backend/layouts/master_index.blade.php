						                    ...
						                    <div class="card-header">
						                        <div class="row align-items-center">
						                            ...
						                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 text-right">
                                                        @if (addAction())
    								                        <a class="btn btn-outline-info" href="{{ route($addNewLink) }}">
                            ...
                            success: function(response) {
                                if (response.isDelete == true) {
                                    swal({
                                        ...
                                        type: "success",
                                        text: response.message == '' ? "Deleted Successfully!" : response.message,
                                        timer: 1000,
                                        html: true,
                                    });
                                    $('.row_'+id).remove();
                                    ...
                                    swal({
                                        ...
                                        type: "error",
                                        text: response.message == '' ? 'Something Wrong! Delete Unsuccessful' : response.message,
                                        // timer: 1000,
                                        html: true,
                                    });
                                }
